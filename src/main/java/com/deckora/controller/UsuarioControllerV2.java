...
public class UsuarioControllerV2 {
    ...
    public ResponseEntity<CollectionModel<EntityModel<Usuario>>> buscarUsuarioPorLetra(
            @Parameter(description = "Letra inicial del Usuario", required = true, example = "s") @PathVariable String letra) {
    ...
    public ResponseEntity<CollectionModel<EntityModel<Usuario>>> buscarUsuarioPorNombreYTipoUsuario(
            @Parameter(description = "Nombre del usuario", required = true, example = "juan") @PathVariable String nombre,
            @Parameter(description = "Id tipo Usuario", required = true, example = "1") @PathVariable Integer idTipoUsuario) {
    ...
    public ResponseEntity<CollectionModel<EntityModel<Usuario>>> buscarUsuarioPorNombreYApellido(
            @Parameter(description = "nombre", required = true, example = "anais") @PathVariable String nombre,
            @Parameter(description = "apellido", required = true, example = "palma") @PathVariable String apellido) {
    ...
    public ResponseEntity<EntityModel<Usuario>> updateUsuario(
            @Parameter(description = "Id del usuario", required = true, example = "1") @PathVariable Long id,
            @Parameter(description = "Detalles del estado", required = true) @RequestBody Usuario Usuario) {
    ...
    public ResponseEntity<EntityModel<Usuario>> patchUsuario(
            @Parameter(description = "Id del usuario", required = true, example = "1") @PathVariable Long id,
            @Parameter(description = "Detalles del estado", required = true) @RequestBody Usuario parcialUsuario) {
    ...
    public ResponseEntity<Void> deleteUsuario(
            @Parameter(description = "Id del estado", required = true, example = "1") @PathVariable Long id) {
